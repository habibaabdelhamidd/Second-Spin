    ...
    return Container(
      ...
      child: Column(
          ...
          child: Image.network(widget.product.image!, fit: BoxFit.cover,
            width: double.infinity,
            height: 135,)),
      Text(widget.product.title!, style: theme.textTheme.bodyLarge, maxLines: 2,),
      Text("EGP ${widget.product.price!}", style: theme.textTheme.labelMedium,),

      Row(
        mainAxisAlignment: MainAxisAlignment.spaceBetween,
        children: [
          Text(widget.product.location!, style: theme.textTheme.bodyMedium),
          ImageIcon(AssetImage("assets/image/Icon fav.png",),
          ...
          Row(children: [
            SizedBox(width: mediaQuery.width / 3.5,),
            GestureDetector(
                onTap: () {
